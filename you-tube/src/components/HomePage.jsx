...
const Options = ["All","4K resolution","JavaScript","Data Structure","Mixes","Music","Movies","News","T-Series","Cartoons","Lives","Lakes","New to you","Blogs","Villages"]
    ...
    return(
        ...
        <div className={navbar?" nav  flex text-white flex-col overflow-x-hidden flex-1 ml-[247px] min-h-screen":"nav flex text-white flex-col overflow-x-scroll flex-1 ml-[77px] min-h-screen"}>
            <div className="flex nav shadow-md shadow-gray-600 text-white fixed top-15 z-1 w-full box-border gap-2.5 shrink-0 h-auto overflow-x-scroll bg-black">
{/*---------------------------------Options--------------------------------------------*/}
                {
...
<div className={navbar?'main_home_page grid box-border bg-black gap-3 grid-cols-[402px_402px_402px] pt-[90px] pb-5 pl-2.5': 'main_home_page grid box-border bg-black gap-3 grid-cols-[342px_342px_342px_342px] pt-[90px] pb-5 pl-2.5 pr-0'}>
                ...
                <div className='you_tube_video flex flex-col box-border text-white no-underline cursor-pointer h-[316px] hover:scale-[1.02] transition-transform duration-200'>
                        ...
                        <div className='title-box '>
                            ...
                            <div className='video_title w-full p-[5px] box-border flex gap-3'>
                                <div className='title font-semibold text-[16px]'>User1</div>
                                 <div className='channel text-sm text-gray-400 mt-1'>alpana@123</div>
                                  <div className='likes text-sm text-gray-400 mt-1'>3 Likes</div>
                                   <div className='Views text-sm text-gray-400 mt-1'>3M </div>
                ...
                <div className='you_tube_video flex flex-col box-border text-white no-underline cursor-pointer h-[316px] hover:scale-[1.02] transition-transform duration-200'>
                        ...
                        <div className='thumnail relative box-border h-[216px]'>                            <img src='https://tinypng.com/images/social/website.jpg' alt='thumnail' className='w-full h-full rounded-[10px]'/>
                            <div className='video-timing absolute bottom-0 right-0 w-auto px-0.5 py-px bg-[rgb(42,42,42)] rounded-[5px]'>
                                12:32
                            </div>
